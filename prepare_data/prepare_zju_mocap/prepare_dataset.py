...
def main(argv):
    ...
    subject_name = subject if 'name' not in cfg['output'].keys() else cfg['output']['name']
    output_path = os.path.join(cfg['output']['dir'], subject_name)
